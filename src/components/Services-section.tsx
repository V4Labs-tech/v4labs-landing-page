...
export default function ServicesSection() {
  ...
  return (
    <>
      ...
      <section className="w-full pt-14 pb-8 px-6 flex flex-col items-center">
        <p className="text-center text-2xl max-w-4xl text-white">
        ...
        <section className="w-full pt-8 pb-14 px-6 flex flex-col items-center">
          ...
          <div className="mt-8 flex flex-col justify-around md:flex-row gap-10 max-w-5xl w-full">
            ...
            <div className="w-2/4 flex flex-col items-center relative">
              ...
              className="bg-primary text-gray-800 px-6 py-3 rounded-full text-md font-semibold shadow-lg hover:shadow-xl transition absolute left-2 bottom-20 cursor-pointer"
            >
              Book a call
            </button>
            </div>
