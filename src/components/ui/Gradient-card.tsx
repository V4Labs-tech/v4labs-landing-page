      ...
      >
        ...
        >
          ...
          >
            ...
            <motion.p
              className="text-lg mt-8 mb-8 text-gray-300"
              style={{
                lineHeight: 1.5,
                fontWeight: 350,
              }}
            ...
            <motion.div
              className="items-center text-center w-2/4 text-sm group bg-primary text-gray-800 px-6 py-4  rounded-4xl text-md font-semibold"
              initial={{ filter: "blur(3px)", opacity: 0.7 }}
              animate={{
                filter: "blur(0px)",
                opacity: 0.9,
