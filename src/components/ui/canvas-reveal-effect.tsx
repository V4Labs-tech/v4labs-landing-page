...
type Uniforms = {
  [key: string]: {
    value: UniformValue;
    type?: string; // Made optional as it's not present for u_resolution
  };
};
...
const ShaderMaterialComponent: FC<ShaderMaterialProps> = ({
  source,
  uniforms,
  maxFps = 60,
}) => {
  ...
  const material = useMemo(() => {
    const getUniforms = (uniforms: Uniforms): Uniforms => {
